...
use 1.2-1.4 and check their correctness. */
        ...
        System.out.println(utilitor.testString("Test String is Pass"));
        try {
        ...
        try {
            ...
            System.out.println("Double is Negative");
        }

        System.out.println("LAST ISBN10 = " + utilitor.computeIsbn10(133456789));
...
use 2.6-2.10 and check their correctness. */
        ...
        Person person1 = new Person("Test", "Person");
...
or it cannot "withdraw" the "amount" from this object.
